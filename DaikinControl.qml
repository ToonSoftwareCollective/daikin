...
Screen {
    id: root
    screenTitle: qsTr("Daikin '" + app.daikinNames[ad] + "' Control")
//    screenTitleIconUrl: "http://localhost/daikin/daikin.png"
...
// No id: colum0HeaderText
    ...
    Text {
        ...
        text: "Airco"
        anchors {
            top: (app.daikinCount > 1 ) ? rectangle5.top : parent.bottom
            topMargin: isNxt ? 20 : 16
...
// Message about leaving to Tile
    ...
    Text {
        id: exitMessage
        text: (app.daikinCount > 1 ) ? "Home button to focus on '" + app.daikinNames[ad] + "' or upper right to monitor all." : ""
        anchors {
